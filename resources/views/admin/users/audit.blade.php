...
@section('content')
<div class="page-head"><div><p class="eyebrow">Keselamatan Sistem</p><h2>Audit Aktiviti Pengguna</h2><p>Jejak perubahan akaun yang dilakukan oleh Super Admin.</p></div><div class="page-actions"><a class="btn" href="{{ route('admin.audit.export',$filters) }}">Eksport CSV</a><a class="btn btn-primary" href="{{ route('admin.users.index') }}">Pengurusan Pengguna</a></div></div>
