        ...
        <div class="career-main">
            ...
            <article class="panel career-section">
                ...
                <div class="form-grid">
                    ...
                    <div class="form-group"><label for="oku_category">Kategori OKU</label><select class="select" id="oku_category" name="oku_category" required><option value="">Pilih kategori</option>@foreach(['Fizikal','Pendengaran','Mental','Pembelajaran','Penglihatan'] as $value)<option @selected(old('oku_category',$oku?->oku_category)===$value)>{{ $value }}</option>@endforeach</select></div>
