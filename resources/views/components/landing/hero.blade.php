                ...
                <div class="preview-body">
                    ...
                    <div class="preview-match">
                        <div class="match-header">
                            ...
                            <span class="match-time">Baru</span>
                        </div>
                        <div class="match-body">
                            <div class="match-avatar"></div>
                            <div class="match-info">
                                <strong>Pembantu Operasi</strong>
                                <span>Majlis Bandaraya • Shah Alam</span>
                                <span class="match-tag">Sesuai dengan profil anda</span>
                            </div>
                        </div>
                        <div class="match-skill-row">
                            <span class="match-skill">Komunikasi</span>
                            <span class="match-skill">Kerja Berpasukan</span>
                            <span class="match-skill">Asas IT</span>
                        </div>
                        <div class="match-footer">
                            <span class="match-match">91% padanan</span>
                            <span class="match-action">Mohon Sekarang →</span>
                        </div>
                    </div>
                </div>
            </div>
