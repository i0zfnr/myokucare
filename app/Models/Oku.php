...
class Oku extends Model
{
    ...
    protected $fillable = ['name', 'ic_number', 'gender', 'age', 'marital_status', 'address', 'education_level', 'oku_card_number', 'oku_category', 'employment_status', 'phone_number', 'email', 'has_smartphone', 'has_internet', 'emergency_contact_name', 'emergency_contact_phone', 'profile_photo_path', 'is_active'];

    protected function casts(): array
    {
        return ['age' => 'integer', 'has_smartphone' => 'boolean', 'has_internet' => 'boolean', 'is_active' => 'boolean'];
    }
